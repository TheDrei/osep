...
@section('table-content')
	<div class="card-header bg-info text-center">
	  <h3 class="display-5">Forward Comments to DPMIS Proposals Table</h3>
	</div>
	<div class="card-body">
...
@section('table-initialize')
	<script type="text/javascript">
		var proposals_table = $('#proposals_table').DataTable({
	        ...
	        ajax: {
	          url: "{{ route('proposals.table_forward_comments_to_dpmis_proposals') }}",
	          method: "GET"
	        },
	        columns: [
				...
				{data: 'date_forwarded_by_trd', name: 'date_forwarded_by_trd'},
