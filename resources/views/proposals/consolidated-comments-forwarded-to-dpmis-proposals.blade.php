...
@section('table-content')
	<div class="card-header bg-info text-center">
	  <h3 class="display-5">Consolidated comments forwarded to DPMIS Proposals Table</h3>
	</div>
	<div class="card-body">
...
@section('table-initialize')
	<script type="text/javascript">
		var proposals_table = $('#proposals_table').DataTable({
	        ...
	        ajax: {
	          url: "{{ route('proposals.table_consolidated_comments_forwarded_to_dpmis_proposals') }}",
	          method: "GET"
	        },
	        columns: [
